...
<%
		...
		WeatherVO vo=weather.getData("osaka");
            ...
            <!-- <div id="banner-wrapper" style=postion:relative;> -->
				...
				<div style="margin: 12px; ">
					...
					<table width="1350" height="1300"  >
							...
							<tr>
								<td rowspan="2" colspan="3" width="75%"  height="40%"><img src="../images/osaka/osaka-intro.jpg" style="width: 100%; height: 470px;"></td>
								 	<!-- 날씨부분 -->
								<td width="25%"  height="20%"  bgcolor=" #0B4C5F"> 
								 	<div class="weather" >
										<div>
											<h3 style= "margin-left: 20px;"><img src="../images/weather/jpn_flag.jpg" style="width: 20px; ">  Osaka, JAPAN</h3>
										</div>
										<div>							
											<table>
											 <tr>
							...
							<tr>
								...
								<div id="map" ></div>
									    <script>
									      ...
									      function initMap() {
									        var myLatLng = {lat: 34.6937, lng: 135.5022};
							...
							<tr>
								<td colspan="2"   width="50%"  height="10%"><img src="../images/osaka/osakaintro.jpg" style="width: 100%; height: auto; "></td>
								<td width="25%"  height="10%"><img src="../images/osaka/osakamoney.jpg" style="width: 100%; height: auto; "></td>
								<td width="25%"  height="10%"><img src="../images/osaka/osakacon.jpg" style="width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td width="25%"  height="25%"><img src="../images/bestfood.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/osaka/osakafood11.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/osaka/osakafood22.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/osaka/osakafood33.jpg" style="width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td width="25%"  height="25%"><img src="../images/osaka/osakaplace1.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/osaka/osakaplace2.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/osaka/osakaplace3.jpg" style="width: 100%; height: auto;"></td>
