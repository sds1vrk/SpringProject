...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css">
   ...
   <%
		...
		WeatherVO vo=weather.getData("Bangkok");
...
<body class="homepage">
	...
	<img class="img-responsive" src="../images/home-bg1.jpg" width="100%" height="400px " style="opacity: 0.8">
      ...
      <div id="banner-wrapper">
         <div class=  style="position: relative; width: auto; height: 1600px">
            <!-- <div id="banner-wrapper" style=postion:relative;> -->
				...
				<div style="margin: 12px; ">
					...
					<table width="1350" height="1300"  >
							...
							<tr>
								<td rowspan="2" colspan="3" width="75%"  height="40%"><img src="../images/bangkok/bangkok-intro.jpg" style="width: 100%; height: 470px;"></td>
											<!-- 날씨부분 -->
								<td width="25%"  height="20%"  bgcolor=" #0B4C5F"> 
								 	<div class="weather" >
										<div>
											<h3 style= "margin-left: 20px;"><img src="../images/weather/tha_flag.jpg" style="width: 20px; ">  BANGKOK, THAILAND</h3>
										</div>
										<div>							
											<table>
											 <tr>
							...
							<tr>
								...
								<div id="map" ></div>
									    <script>
									      ...
									      function initMap() {
									        var myLatLng = {lat: 13.7563, lng: 100.5018};
							...
							<tr>
								<td colspan="2"   width="50%"  height="10%"><img src="../images/bangkok/bangkokintro.jpg" style="width: 100%; height: auto; "></td>
								<td width="25%"  height="10%"><img src="../images/bangkok/bangkokmoney.jpg" style="width: 100%; height: auto; "></td>
								<td width="25%"  height="10%"><img src="../images/bangkok/bangkokcon.jpg" style="width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td width="25%"  height="25%"><img src="../images/bestfood.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/bangkok/bangkokfood1.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/bangkok/bangkokfood2.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/bangkok/bangkokfood3.jpg" style="width: 100%; height: auto;"></td>
							</tr>
							<tr>
								<td width="25%"  height="25%"><img src="../images/bangkok/bangkokplace1.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/bangkok/bangkokplace2.jpg" style="width: 100%; height: auto;"></td>
								<td width="25%"  height="25%"><img src="../images/bangkok/bangkokplace3.jpg" style="width: 100%; height: auto;"></td>
