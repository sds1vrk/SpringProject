...
<br><br><br><br><br>
<form method="post"  name="diaryInput" action="update_ok.jsp" onsubmit="return checkfield()">
	<br>
			...
			<td align="center" valign="top" >
				...
				<table width="300" height="200" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<tr>
						...
						<input style="width:80px; height:30px;" type="text" name="resort"maxlength="30" class="resort" value="<%=vo.getResort() %>" autofocus>
						</td>
					</tr>
					<tr>
						<td width="300" height="20" align="left" class="title"><font>관광지 :</font>&nbsp;
						<input style="width:80px; height:30px;" type="text" name="place"size="12" maxlength="30" class="place" value="<%=vo.getPlace() %>"  autofocus>
						</td>
					</tr>
				</table>
